...
-- Lets create  a before and after  statement and row level trriggers for the Product table
...
BEGIN
	INSERT INTO Product_cheer VALUES(
		'After update, statement level: Syntax'
	);
END;
...
-- Lets check the data in Product_cheer table to see the order in which the
-- trigger is tried
